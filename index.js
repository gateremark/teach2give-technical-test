...
function hasConsecutiveThrees(ints) {
  for (let i = 0; i < ints.length - 1; i++) {
    if (ints[i] === 3 && ints[i + 1] === 3) {
      return true;
    }
  }
...
console.log(hasConsecutiveThrees([3, 3, 3])); // true
...
console.log(masterYoda("I am home")); // home am I
console.log(masterYoda("Hello world")); // world Hello
console.log(masterYoda("The quick brown fox")); // fox brown quick The
